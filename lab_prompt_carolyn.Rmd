...
co2_present <- mutate(co2_present, date = as.Date(paste(year, month, day, sep="-"))) %>% mutate(week = yearweek(date))
...
bind_cols(data.frame(
	model=c('ARIMA(1,0,4)(1,1,0)[52] (NSA data)', 'ARIMA(0,1,2)(1,0,0)[52] (SA data)', 'ARIMA(1,0,1)(1,1,0)[52] (NSA data)', 'ARIMA(0,1,3)(2,0,0)[52] (SA data)'),
...
sa.fc %>% fabletools::accuracy(select(test.df, week, season_adjust))
```
...
sa.poly.fc %>% fabletools::accuracy(select(test.df, week, season_adjust))
```
